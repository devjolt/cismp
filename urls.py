...
from . import views
from .cismp_modules import _1, _3, _4, _5, _6, _7, _8, _10
from .views import HomeView, RandomModuleView


urlpatterns = [
    path('', HomeView.as_view(), name='cismp_home'),
    path('random/', RandomModuleView.as_view(modules = (_3, _4, _5, _6, _7, _8, _10)), name = 'all_random'),
    ...
    path('cloud_security/', RandomModuleView.as_view(modules = (_10,)), name = 'cloud_security'),
